  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <?php
        ...
        Page Title
        <input type="text" name="page_title" class="form-control"  aria-describedby="emailHelp" placeholder="Page Title"
        value="<?php echo $pageTitle; ?>" ><br>

        

        Page Content 
        <textarea class="form-control" name="page_content" id="exampleFormControlTextarea1" rows="5"><?php echo $pageContent; ?></textarea><br>
