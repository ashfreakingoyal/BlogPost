  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
     ...
     <form method="post">
        ...
        <input type="text" name="home_jumbo_title" class="form-control" placeholder="Enter HomePage Title" value="<?php getsettingValue("home_jumbo_title"); ?>"><br>
        HomePage Jumbotron Desc
        <input type="text" name="home_jumbo_desc" class="form-control" placeholder="Enter HomePage Desc" value="<?php getsettingValue("home_jumbo_desc"); ?>"><br>
