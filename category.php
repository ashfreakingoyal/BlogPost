...
<!--posts---------------------------------->
<div class="container">
<h1 style="width:100%;padding-top:25px;padding-bottom:25px;background-color:grey;color:white;text-align:center;">Showing All Posts For Category <?php echo getCategoryName('$id'); ?></h1>
